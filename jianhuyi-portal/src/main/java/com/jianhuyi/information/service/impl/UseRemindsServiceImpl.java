...
public class UseRemindsServiceImpl implements UseRemindsService {
  @Autowired private UseRemindsDao useRemindsDao;
  ...
  @Override
  public UseJianhuyiLogDO getTodayReminds(Long userId, String time) {
    return useRemindsDao.getTodayReminds(userId, time);
  }
}
