...
public class ResultUtils {
  ...
  public static String totalDegree(UserTaskDO userTaskDO, UserTaskLinshiDO userTaskLinshiDO) {
    if (ifY(userTaskDO, userTaskLinshiDO)) return "5";
    if (ifL(userTaskDO, userTaskLinshiDO)) return "4";
    if (ifC(userTaskDO, userTaskLinshiDO)) return "3"; // 不太好
    if (ifJC(userTaskDO, userTaskLinshiDO)) return "2"; // 差
    return "1";
  }
  ...
  public static boolean ifY(UserTaskDO userTaskDO, UserTaskLinshiDO userTaskLinshiDO) {
    if (userTaskLinshiDO != null) {
      if ("5".equals(userTaskLinshiDO.getAvgRead())
        ...
        if ("5".equals(userTaskLinshiDO.getAvgLight())
            || "4".equals(userTaskLinshiDO.getAvgLight())) l.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgLookPhone())
            || "4".equals(userTaskLinshiDO.getAvgLookPhone())) l.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgLookTv())
            || "4".equals(userTaskLinshiDO.getAvgLookTv())) l.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgSitTilt())
            || "4".equals(userTaskLinshiDO.getAvgSitTilt())) l.add("c");
        if (l.size() >= 3) {
          if ("5".equals(userTaskLinshiDO.getEffectiveUseTime())
              || "4".equals(userTaskLinshiDO.getEffectiveUseTime())) return true;
          else return false;
        } else {
          return false;
        }
      ...
      if ("5".equals(userTaskDO.getAvgRead())
        ...
        if (l.size() >= 3) {
          if ("5".equals(userTaskDO.getEffectiveUseTime())
              || "4".equals(userTaskDO.getEffectiveUseTime())) return true;
          else return false;
        } else {
          return false;
        }
  ...
  public static boolean ifL(UserTaskDO userTaskDO, UserTaskLinshiDO userTaskLinshiDO) {
    if (userTaskLinshiDO != null) {
      if (("5".equals(userTaskLinshiDO.getAvgRead()) || "4".equals(userTaskLinshiDO.getAvgRead()))
          && ("5".equals(userTaskLinshiDO.getAvgOut()) || "4".equals(userTaskLinshiDO.getAvgOut()))
          && ("5".equals(userTaskLinshiDO.getAvgReadDistance())
              || "4".equals(userTaskLinshiDO.getAvgReadDistance()))) {

        List<String> l = new ArrayList<String>();
        if ("5".equals(userTaskLinshiDO.getAvgLight())
            || "4".equals(userTaskLinshiDO.getAvgLight())
            || "2".equals(userTaskLinshiDO.getAvgLight())) l.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgLookPhone())
            || "4".equals(userTaskLinshiDO.getAvgLookPhone())
            || "2".equals(userTaskLinshiDO.getAvgLookPhone())) l.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgLookTv())
            || "4".equals(userTaskLinshiDO.getAvgLookTv())
            || "2".equals(userTaskLinshiDO.getAvgLookTv())) l.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgSitTilt())
            || "4".equals(userTaskLinshiDO.getAvgSitTilt())
            || "2".equals(userTaskLinshiDO.getAvgSitTilt())) l.add("c");
        if (l.size() <= 1) {
          if ("5".equals(userTaskLinshiDO.getEffectiveUseTime())
              || "4".equals(userTaskLinshiDO.getEffectiveUseTime())) return true;
          else return false;
      ...
      if (("5".equals(userTaskDO.getAvgRead()) || "4".equals(userTaskDO.getAvgRead()))
          && ("5".equals(userTaskDO.getAvgOut()) || "4".equals(userTaskDO.getAvgOut()))
          && ("5".equals(userTaskDO.getAvgReadDistance())
              || "4".equals(userTaskDO.getAvgReadDistance()))) {

        List<String> l = new ArrayList<String>();
        if ("5".equals(userTaskDO.getAvgLight())
            || "4".equals(userTaskDO.getAvgLight())
            || "2".equals(userTaskDO.getAvgLight())) l.add("c");
        if ("5".equals(userTaskDO.getAvgLookPhone())
            || "4".equals(userTaskDO.getAvgLookPhone())
            || "2".equals(userTaskDO.getAvgLookPhone())) l.add("c");
        if ("5".equals(userTaskDO.getAvgLookTv())
            || "4".equals(userTaskDO.getAvgLookTv())
            || "2".equals(userTaskDO.getAvgLookTv())) l.add("c");
        if ("5".equals(userTaskDO.getAvgSitTilt())
            || "4".equals(userTaskDO.getAvgSitTilt())
            || "2".equals(userTaskDO.getAvgSitTilt())) l.add("c");
        if (l.size() <= 1) {
          if ("5".equals(userTaskDO.getEffectiveUseTime())
              || "4".equals(userTaskDO.getEffectiveUseTime())) return true;
          else return false;
  ...
  public static boolean ifC(UserTaskDO userTaskDO, UserTaskLinshiDO userTaskLinshiDO) {
    if (userTaskLinshiDO != null) {
      ...
      if (("5".equals(userTaskLinshiDO.getAvgRead()))
          ...
          || "2".equals(userTaskLinshiDO.getAvgRead())) l.add("c");
      if (("5".equals(userTaskLinshiDO.getAvgOut()))
          || "4".equals(userTaskLinshiDO.getAvgOut())
          || "2".equals(userTaskLinshiDO.getAvgOut())) l.add("c");
      if (("5".equals(userTaskLinshiDO.getAvgReadDistance()))
          || "4".equals(userTaskLinshiDO.getAvgReadDistance())
          || "2".equals(userTaskLinshiDO.getAvgReadDistance())) l.add("c");
      if (l.size() <= 1) {
        List<String> ll = new ArrayList<String>();
        if ("5".equals(userTaskLinshiDO.getAvgLight())
            || "4".equals(userTaskLinshiDO.getAvgLight())
            || "2".equals(userTaskLinshiDO.getAvgLight())) ll.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgLookPhone())
            || "4".equals(userTaskLinshiDO.getAvgLookPhone())
            || "2".equals(userTaskLinshiDO.getAvgLookPhone())) ll.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgLookTv())
            || "4".equals(userTaskLinshiDO.getAvgLookTv())
            || "2".equals(userTaskLinshiDO.getAvgLookTv())) ll.add("c");
        if ("5".equals(userTaskLinshiDO.getAvgSitTilt())
            || "4".equals(userTaskLinshiDO.getAvgSitTilt())
            || "2".equals(userTaskLinshiDO.getAvgSitTilt())) ll.add("c");
        if (ll.size() <= 1) {
          if ("5".equals(userTaskLinshiDO.getEffectiveUseTime())
              || "4".equals(userTaskLinshiDO.getEffectiveUseTime())
              || "2".equals(userTaskLinshiDO.getEffectiveUseTime())) return true;
          else return false;
        } else {
          return false;
        }
      ...
      if (("5".equals(userTaskDO.getAvgRead()))
          ...
          || "2".equals(userTaskDO.getAvgRead())) l.add("c");
      if (("5".equals(userTaskDO.getAvgOut()))
          || "4".equals(userTaskDO.getAvgOut())
          || "2".equals(userTaskDO.getAvgOut())) l.add("c");
      if (("5".equals(userTaskDO.getAvgReadDistance()))
          || "4".equals(userTaskDO.getAvgReadDistance())
          || "2".equals(userTaskDO.getAvgReadDistance())) l.add("c");
      if (l.size() <= 1) {
        List<String> ll = new ArrayList<String>();
        if ("5".equals(userTaskDO.getAvgLight())
            || "4".equals(userTaskDO.getAvgLight())
            || "2".equals(userTaskDO.getAvgLight())) ll.add("c");
        if ("5".equals(userTaskDO.getAvgLookPhone())
            || "4".equals(userTaskDO.getAvgLookPhone())
            || "2".equals(userTaskDO.getAvgLookPhone())) ll.add("c");
        if ("5".equals(userTaskDO.getAvgLookTv())
            || "4".equals(userTaskDO.getAvgLookTv())
            || "2".equals(userTaskDO.getAvgLookTv())) ll.add("c");
        if ("5".equals(userTaskDO.getAvgSitTilt())
            || "4".equals(userTaskDO.getAvgSitTilt())
            || "2".equals(userTaskDO.getAvgSitTilt())) ll.add("c");
        if (ll.size() <= 1) {
          if ("5".equals(userTaskDO.getEffectiveUseTime())
              || "4".equals(userTaskDO.getEffectiveUseTime())
              || "2".equals(userTaskDO.getEffectiveUseTime())) return true;
          else return false;
        } else {
          return false;
        }
      ...
      if (l.size() <= 2) {
        ...
        if (ll.size() <= 3) {
          if ("5".equals(userTaskLinshiDO.getEffectiveUseTime())
              ...
              || "1".equals(userTaskLinshiDO.getEffectiveUseTime())) return true;
          else return false;
        } else {
          return false;
        }
      ...
      if (l.size() <= 2) {
        ...
        if (ll.size() <= 3) {
          if ("5".equals(userTaskDO.getEffectiveUseTime())
              ...
              || "1".equals(userTaskDO.getEffectiveUseTime())) return true;
          else return false;
        } else {
          return false;
        }
  ...
  public static int countScore(UserTaskDO userTaskDO, UserTaskLinshiDO userTaskLinshiDO) {
    ...
    if (userTaskDO.getTaskType() == null || userTaskDO.getTaskType() == 2) {
      ...
      Integer score6 =
          StrC(userTaskDO.getAvgReadDistance(), userTaskLinshiDO.getAvgReadDistance()) == 1
              ? (userTaskDO.getAvgReadDistanceScore() == null
                  ? 0
                  : userTaskDO.getAvgReadDistanceScore())
              : 0;
      Integer score7 =
          StrC(userTaskDO.getAvgSitTilt(), userTaskLinshiDO.getAvgSitTilt()) == 1
  ...
  public static int StrC(String a, String b) {
    if (a != null && b != null && a.compareTo(b) <= 0) return 1;
    else return 0;
  }
  ...
  public static Map<String, Double> countData(
    ...
    for (int i = 0; i < useJianhuyiLogDOList.size(); i++) {
      ...
      if (useJianhuyiLogDO.getReadLight() != null
          ...
          && useJianhuyiLogDO.getReadDistance() != null
    ...
    if (lookScreenCount > 0) {
      avgLookTvComputerDuration =
          Double.parseDouble(df.format(avgLookTvComputerDuration / lookScreenCount));
    }
