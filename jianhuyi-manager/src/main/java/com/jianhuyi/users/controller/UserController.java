...
public class UserController {
  ...
  public R saveBind(UserDO user) throws ParseException {
    ...
    for (String s : id) {
      ...
      userDO.setId(Long.parseLong(s));
      userDO.setManagerId(user.getManagerId());
