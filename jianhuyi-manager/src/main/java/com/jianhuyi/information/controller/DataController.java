...
public class DataController {
	...
	public PageUtils list(@RequestParam Map<String, Object> params){
		...
		for (DataDO dataDO : dataList) {
			params.clear();
			params.put("dataid",dataDO.getId());
			List<DataImgDO> imgDOList = dataImgService.list(params);
	...
	@GetMapping("/jiaodu/{id}")
	String jiaodu(@PathVariable("id") Long id,Model model){
