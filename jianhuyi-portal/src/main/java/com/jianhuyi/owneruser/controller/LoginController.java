...
public class LoginController extends BaseController {
  ...
  @Autowired OwnerUserDao ownerUserMapper;

  @Autowired OwnerUserService userService;
  @Autowired private ISMSService sMSService;
  @Autowired private FunctionSetService functionSetService;

  @Log("密码登录")
  @PostMapping("/loginP")
  R loginP(String phone, String password) {
  ...
  */
  ...
  /**
   * @param phone 手机号
   * @param type 类型 0：注册 1：登录 2：密码重置 @说明 发送验证码
   */
  @Log("发送验证码")
  @PostMapping("/getSms")
      ...
      if (phone == null || "".equals(phone)) {
        ...
        DefaultProfile profile =
            DefaultProfile.getProfile(
                "default", "LTAI4G6bVPTi1kdS9DVzD4Us", "8UzvN8UI0iHxIbC5DTc15Zg4TlZRmU");
